...
Tables:
    ...
    - Entry: Journal entry metadata from Markdown frontmatter (with soft delete)
    ...
    - AssociationTombstone: Tracks deleted many-to-many associations
    - SyncState: Tracks synchronization state for conflict detection
    - EntitySnapshot: Snapshots of entity state for audit/recovery
...
==============
    ...
    - Tombstone pattern enables multi-machine synchronization
...
class SyncState(Base):
    ...
    conflict_detected: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
