	...
	if #vim.g.vimwiki_list > 1 then
		...
		wk.add({
			...
			{ "<leader>v", group = "vimwiki" },
			{
				...
				{ "<leader>pP", "<cmd>PalimpsestPublish<cr>", desc = "Wiki publish (Quartz)" },
				-- Validators
				{ "<leader>pv", group = "validators" },
				{ "<leader>pvw", "<cmd>PalimpsestLint<cr>", desc = "Lint wiki pages" },
				{ "<leader>pvf", "<cmd>PalimpsestValidateFrontmatter<cr>", desc = "Validate frontmatter" },
				{ "<leader>pvm", "<cmd>PalimpsestValidateMetadata<cr>", desc = "Validate frontmatter structure" },
				{ "<leader>pvl", "<cmd>PalimpsestValidateLinks<cr>", desc = "Validate markdown links" },
				{ "<leader>pve", "<cmd>PalimpsestValidateEntry<cr>", desc = "Validate entry (quickfix)" },
				...
				{ "<leader>pme", "<cmd>PalimpsestGenerate manuscript<cr>", desc = "Generate manuscript" },
				{ "<leader>pmi", "<cmd>PalimpsestSync ingest<cr>", desc = "Ingest manuscript edits" },
		...
		wk.add({
			{
				...
				{ "<leader>vP", "<cmd>PalimpsestPublish<cr>", desc = "Wiki publish (Quartz)" },
				-- Validators
				{ "<leader>vv", group = "validators" },
				{ "<leader>vvw", "<cmd>PalimpsestLint<cr>", desc = "Lint wiki pages" },
				{ "<leader>vvf", "<cmd>PalimpsestValidateFrontmatter<cr>", desc = "Validate frontmatter" },
				{ "<leader>vvm", "<cmd>PalimpsestValidateMetadata<cr>", desc = "Validate frontmatter structure" },
				{ "<leader>vvl", "<cmd>PalimpsestValidateLinks<cr>", desc = "Validate markdown links" },
				{ "<leader>vve", "<cmd>PalimpsestValidateEntry<cr>", desc = "Validate entry (quickfix)" },
				...
				{ "<leader>vme", "<cmd>PalimpsestGenerate manuscript<cr>", desc = "Generate manuscript" },
				{ "<leader>vmi", "<cmd>PalimpsestSync ingest<cr>", desc = "Ingest manuscript edits" },
